					...
					"config": {
						"inbounds": {
							"SmartTable-display": {
								...
								"action": "display",
								"description": "A Fiori application for Smart Table and fields",
								"title": "Smart Table",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project1module",
									"url": sap.ui.require.toUrl("project1module")
								}
							}
						}
					}
